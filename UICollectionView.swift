...
public extension UICollectionView {
    ...
    func dequeueReusableCell<T: UICollectionViewCell>(
        ...
        dequeueReusableCell(withReuseIdentifier: type.className, for: indexPath) as! T // swiftlint:disable:this force_cast
    }
    ...
    func dequeueReusableView<T: UICollectionReusableView>(
        ...
        dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: type.className, for: indexPath) as! T // swiftlint:disable:this force_cast
    }
}
